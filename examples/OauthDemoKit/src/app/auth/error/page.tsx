...
export default function AuthError() {
  ...
  useEffect(() => {
    ...
    try {
      const configDetails = {
        authURL: `${process.env.NEXT_PUBLIC_DJANGO_API_URL}/api/e/v1/oauth/authorize/`,
        tokenURL: `${process.env.NEXT_PUBLIC_DJANGO_API_URL}/api/e/v1/oauth/token/`,
        userinfoURL: `${process.env.NEXT_PUBLIC_DJANGO_API_URL}/api/e/v1/oauth/userinfo/`,
